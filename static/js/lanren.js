...
function setRigth(year,yue,day){
	...
	var table=withClass("aboluo-rilidiv");//134px
	var thead=withClass("aboluo-rilithead");//20px
	//alert(table.offsetHeight);
	//alert(thead.offsetHeight)
	var tbodyheight=table.offsetHeight+thead.offsetHeight+21;

	rigthdiv.style.height = tbodyheight+"px";
	//给p中添加span显示值
...
function getA(year,yue,day){
	var a=newElement("a");
	a.href = "/games/list?date=" + year+"-"+yue+"-"+day
	a.innerHTML=day;
